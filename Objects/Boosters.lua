--TODO: Add sounds for specific cells in specific booster packs in the craftsweeper minigame.
--TODO: Consider moving craftsweeper stuff to it's own lua file.
--Ex: Lava sound when lava is revealed.
...
--Update discovered cells with numbers, depending on mines nearby.
...
--Uncover cells on click. Includes strumming.
--Also, generates the board when starting out to ensure the first click is never a mine.
...
--Overworld Resource Pack
SMODS.Booster {
    key = 'overworld_resource_booster',
    atlas = 'mc_packs',
    group_key = 'k_mc_resource_pack',
    loc_txt = {
        name = "Overworld Resource Pack",
        text = {
            "TODO: Implement proper loc.txt!"
        }
    },
    weight = 1,
    cost = 4,
...
--Deepslate Resource Pack
SMODS.Booster {
    key = 'deep_resource_booster',
    atlas = 'mc_ani_packs',
    group_key = 'k_mc_resource_pack',
    loc_txt = {
...
--Nether Resource Pack
SMODS.Booster {
    key = 'nether_resource_booster',
    atlas = 'mc_packs',
    group_key = 'k_mc_resource_pack',
    loc_txt = {
        name = "Nether Resource Pack",
        text = {
            "TODO: Implement proper loc.txt!"
        }
    },
